...
function printContractTemplate() {
  ...
  var html = '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>'+esc(ct.label)+' — '+esc(c.number||'')+'</title>'
    ...
    +'<p style="font-size:11px;color:#546e7a;font-style:italic">This contract is governed by the terms of '+esc((typeof coFullName==='function'?coFullName():'')||'our company')+'\'s standard '+esc(ct.label)+'. A complete copy of the governing terms and conditions is attached or available upon request.</p>'
    +'<div style="margin-top:40px;display:grid;grid-template-columns:1fr 1fr;gap:40px">'
      +'<div style="border-top:1px solid #000;padding-top:6px;font-size:11px;color:#546e7a">Client Signature &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Date</div>'
      +'<div style="border-top:1px solid #000;padding-top:6px;font-size:11px;color:#546e7a">'+esc((typeof coFullName==='function'?coFullName():'')||'Company')+' — Authorized Signature &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Date</div>'
    +'</div>'
